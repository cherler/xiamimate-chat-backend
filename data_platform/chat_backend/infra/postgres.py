"""PostgreSQL connection pool, query helpers, and schema bootstrap.

Depends only on ``infra.settings``.
"""
...
from data_platform.chat_backend.infra.settings import INIT_APP_TABLES_SQL
