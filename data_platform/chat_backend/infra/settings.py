...
WECHAT_PAY_ENABLED = os.environ.get("CHAT_BACKEND_WECHAT_PAY_ENABLED", "false").strip().lower() in {"1", "true", "yes", "on"}
WECHAT_MCH_ID = os.environ.get("CHAT_BACKEND_WECHAT_MCH_ID", "").strip()
WECHAT_APP_ID = os.environ.get("CHAT_BACKEND_WECHAT_APP_ID", "").strip()
WECHAT_API_V3_KEY = os.environ.get("CHAT_BACKEND_WECHAT_API_V3_KEY", "").strip()
WECHAT_PRIVATE_KEY = os.environ.get("CHAT_BACKEND_WECHAT_PRIVATE_KEY", "").strip()
WECHAT_PRIVATE_KEY_FILE = os.environ.get("CHAT_BACKEND_WECHAT_PRIVATE_KEY_FILE", "").strip()
WECHAT_CERT_SERIAL_NO = os.environ.get("CHAT_BACKEND_WECHAT_CERT_SERIAL_NO", "").strip()
WECHAT_NOTIFY_URL = os.environ.get("CHAT_BACKEND_WECHAT_NOTIFY_URL", "").strip()
WECHAT_PLATFORM_PUBLIC_KEY_FILE = os.environ.get("CHAT_BACKEND_WECHAT_PLATFORM_PUBLIC_KEY_FILE", "").strip()
WECHAT_PLATFORM_PUBLIC_KEY_ID = os.environ.get("CHAT_BACKEND_WECHAT_PLATFORM_PUBLIC_KEY_ID", "").strip()
WECHAT_PLATFORM_CERT_FILE = os.environ.get("CHAT_BACKEND_WECHAT_PLATFORM_CERT_FILE", "").strip()
WECHAT_NATIVE_QR_TTL_SECONDS = min(
    7200,
    max(300, int(os.environ.get("CHAT_BACKEND_WECHAT_NATIVE_QR_TTL_SECONDS", "900"))),
)
...
DEFAULT_BILLING_PACKAGES: list[dict[str, Any]] = [
    {
        ...
        "meta_json": {
            ...
            "tier_key": "standard",
            "display_price": "19 RMB / month",
            "display_points": "300 points / month",
            "display_name": "Standard 标准版",
            "display_tagline": "适合轻量稳定使用",
            "renewal_price_cents": 1900,
            "renewal_price_label": "19元/月",
            "seed_catalog": "2026-07-pricing-adjustment",
        },
    },
    {
        ...
        "meta_json": {
            ...
            "display_points": "600 points / month",
    ...
    },
    {
        ...
        "meta_json": {
            ...
            "display_points": "1600 points / month",
    ...
    },
    {
        ...
        "meta_json": {
            ...
            "display_points": "100 points",
            "display_name": "充值包 100",
            "display_tagline": "10 积分 = 1 元",
            "seed_catalog": "2026-04-launch",
        },
    },
    {
        "package_code": "recharge_3000",
        "package_name": "充值包 300",
        "product_type": "credit_pack",
        "price_cents": 3000,
        "points_amount": 300,
        "period_days": 0,
        ...
        "meta_json": {
            ...
            "display_points": "300 points",
            "display_name": "充值包 300",
            "display_tagline": "10 积分 = 1 元",
            "seed_catalog": "2026-04-launch",
        },
    },
    ...
    },
    {
        ...
        "meta_json": {
            ...
            "display_points": "5000 points",
            "display_name": "充值包 5000",
            "display_tagline": "10 积分 = 1 元",
            "seed_catalog": "2026-04-launch",
        },
    },
...
DEFAULT_PROMOTION_RULES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "meta_json": {
            "zone_code": "recharge_zone",
            "display_text": "累计充值满 100 元，额外送 100 积分",
            "seed_catalog": "2026-04-launch",
        },
        "display_order": 210,
    },
    {
        ...
        "meta_json": {
            "zone_code": "recharge_zone",
            "display_text": "累计充值满 500 元，额外送 800 积分",
            "seed_catalog": "2026-04-launch",
        },
        "display_order": 220,
    },
    {
        ...
        "meta_json": {
            "zone_code": "recharge_zone",
            "display_text": "累计充值满 1000 元，额外送 2000 积分",
            "seed_catalog": "2026-04-launch",
        },
        "display_order": 230,
    },
